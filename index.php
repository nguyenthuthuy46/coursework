...
<section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        ...
        <h2>Wisdom is not a product from school, but a lifelong learning process.</h2>
            ...
            <div class="row">
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="content">
                        ...
                        <p>
                            Here are some prominent articles of the system that bring high research value.
                        </p>
                        <div class="text-center">
                            <a href="about.html" class="more-btn">Show All <i class="bx bx-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    ...
                                    <p>Author: <span>Nguyen Van A</span></p>
                                    <p>Published: <span>12/02/20020</span></p>
                                </div>
                            </div>
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4>Our Services</h4>
                        <ul>
                            <li><i class="bx bx-chevron-right"></i> <a href="#">Manage contribution</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="#">Manage faculty</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="#">Manage user</a></li>
